...
@app.post("/lookup", response_model=LinkedInLookupResponse, description="Lookup a LinkedIn profile and return metadata including name, headline, company, and location.")
